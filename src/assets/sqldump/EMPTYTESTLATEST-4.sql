...
insert  into `student_elective`(`student_elective_id`,`user_id`,`elective_id`,`enrollment_status`,`student_id`,`grade_level`,`school_year_id`,`section_id`) values (1,14,3,'approved',1,7,1,1),(3,15,3,'approved',2,7,1,2);
