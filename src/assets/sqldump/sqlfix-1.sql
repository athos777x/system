...
insert  into `subject`(`subject_id`,`grade_level`,`subject_name`,`status`,`grading_criteria`,`description`,`archive_status`,`school_year_id`,`employee_id`,`elective`,`max_capacity`) values (1,7,'English 7','active',NULL,'English Class','unarchive',1,NULL,'N',NULL),(2,7,'Physical Education 7','active',NULL,'PE 7 REGULAR','unarchive',1,NULL,'N',NULL),(3,NULL,'Spanish101','active',NULL,'Spanish Elective Class','unarchive',1,NULL,'Y',50),(4,NULL,'Japanese101','active',NULL,'Japanese Elective Class','archive',1,NULL,'Y',NULL),(5,7,'Math 7','active',NULL,'Math101','unarchive',1,NULL,'N',NULL),(6,8,'English 8','active',NULL,'English','archive',1,NULL,'N',NULL),(7,9,'Biology 9','active',NULL,'Biology','archive',1,NULL,'N',NULL);
