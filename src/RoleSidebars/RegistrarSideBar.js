...
function RegistrarSideBar({ showSidebar, toggleSidebar, handleLogout }) {
  ...
  const isEnrollmentPath = ['/pending-enrollment', '/enroll-student', '/pending-elective', '/school-year', '/section-list', '/enrolled-students', '/brigada-eskwela', '/brigada-eskwela-view'].includes(location.pathname);
